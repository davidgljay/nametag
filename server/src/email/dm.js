module.exports = ({roomId, roomName, message, author, loginHash}) => ({
  subject: `You have been sent a private message in ${roomName}`,
  txt: `You have been sent a private message:\n
  \n
      ${message}\n
      -${author}\n
  \n
...
<tr>
    <td style="text-align: center;"><h2>You have been sent a private message in ${roomName}</h2></td>
</tr>
<tr>
