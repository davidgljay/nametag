...
<tr>
    <td style="text-align: center;"><h2>${author} has replied to your comment in ${roomName}</h2></td>
</tr>
<tr>
    ...
    <td style="text-align: center">
        <a href="https://nametag.chat/rooms/${roomId}?showReplies=${messageId}" target='_blank'>
